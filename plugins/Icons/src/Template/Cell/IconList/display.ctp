<div class="icon-list-cell">
    <?= $this->Html->script('Icons.app'); ?>
    <?= $this->Html->css(['Icons.ionicons.min', 'Icons.stylesheet']); ?>

    <div class="value" style="float: left;">
        <?= $this->Form->input($input_name, ['value' => $value, 'class' => 'icon-class-input', 'type' => 'hidden']) ?>
        <a class="btn btn-default" style="font-size: 40px;width: 70px;">
            <span class="<?= $value ?>" id="icon-value-button" data-pack="default"></span>
        </a>
    </div>
    ...
    <div class="icon-list">
        ...
        <div id="icon-panel" style="top: -9999px;">
