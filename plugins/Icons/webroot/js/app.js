...
window.onload = function () {
    ...
    function panelClick(e) {
        ...
        var icon_input = document.getElementsByClassName('icon-class-input')[0];
        icon_input.value = e.target.className;

        var icon_value_button = document.getElementById('icon-value-button');
        icon_value_button.className = e.target.className;
